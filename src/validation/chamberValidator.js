...
module.exports.saveChamber = [
    ...
    body("operating_hours").trim().escape().notEmpty().withMessage("The operating hours field is required"),
    body("operating_hours_bn").trim().escape().notEmpty().withMessage("The operating hours bn field is required"),
