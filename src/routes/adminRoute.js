...
router.post("/login", authValidator.loginValidator, authController.loginPost);
router.post("/password-change", authAdminMiddleware, authValidator.changePassValidator, authController.changePassword);
